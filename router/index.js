...
const statsHandler = async (ctx, next) => {
  try {
    ...
    if (error.code === 'ENOENT') {
      console.warn('⚠️  Database stats not yet generated by collector')
      ctx.body = {
        message: 'Database statistics not yet available',
        info: 'Stats are generated by eddata-collector and updated periodically',
        status: 'pending'
      }
    } else {
