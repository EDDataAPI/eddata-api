...
const { EDDATA_MARKET_TICKER_CACHE } = require('../consts')
...
module.exports = async () => {
  ...
  try {
    await fsPromises.writeFile(EDDATA_MARKET_TICKER_CACHE, JSON.stringify(data, null, 2), 'utf8')
  } catch (error) {
    console.error('Error writing commodity ticker cache:', error)
  }
}
